    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thinker_status', models.CharField(default='so so', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='feedback_likes', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-pub_date'],
                'abstract': False,
